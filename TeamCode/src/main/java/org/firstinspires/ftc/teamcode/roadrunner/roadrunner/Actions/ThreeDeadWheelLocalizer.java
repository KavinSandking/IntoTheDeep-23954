...
import org.firstinspires.ftc.teamcode.roadrunner.roadrunner.Actions.messages.ThreeDeadWheelInputsMessage;

//test
@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1415.9061754561735; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1586.57816413128; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1910.860361883462; // x position of the perpendicular encoder (in tick units)
    }
